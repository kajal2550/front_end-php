...
<head>
    ...
    <title>Guided Exercise - ZenSpace</title>
        ...
        <section class="relative py-20 gradient-bg">
            <div class="container mx-auto px-4">
                <div class="max-w-3xl mx-auto text-center">
                    <h1 class="text-4xl md:text-5xl font-bold mb-6 text-gray-800 dark:text-white fade-in">Guided Exercise</h1>
                    <p class="text-lg mb-8 text-gray-600 dark:text-gray-300 fade-in">
                        Select from our collection of physical exercises designed to help you strengthen, energize, and revitalize your body.
                    </p>
                    ...
                    <div class="mb-8 fade-in">
                        ...
                        <div class="flex flex-wrap justify-center gap-3 mb-10">
                            ...
                            <button class="category-filter bg-white dark:bg-gray-800 text-gray-800 dark:text-white px-4 py-2 rounded-full hover:shadow-md transition duration-300" data-category="strength">
                                Strength
                            </button>
                            <button class="category-filter bg-white dark:bg-gray-800 text-gray-800 dark:text-white px-4 py-2 rounded-full hover:shadow-md transition duration-300" data-category="flexibility">
                                Flexibility
                            </button>
                            <button class="category-filter bg-white dark:bg-gray-800 text-gray-800 dark:text-white px-4 py-2 rounded-full hover:shadow-md transition duration-300" data-category="cardio">
                                Cardio
                            </button>
                        </div>
                    </div>
            ...
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="meditation-session bg-gray-50 dark:bg-gray-700 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300 transform hover:-translate-y-1 fade-in" data-duration="5" data-category="beginner">
                        <div class="relative">
                            <img src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80" alt="Beginner Exercise" class="w-full h-48 object-cover">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Gentle Stretch Routine</h3>
                            <p class="text-gray-600 dark:text-gray-300 mb-4">
                                A gentle introduction to stretching and movement with basic exercises suitable for beginners of all fitness levels.
                            </p>
                            <div class="mb-4 flex flex-wrap gap-2">
                                <span class="inline-block bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary-light text-xs px-2 py-1 rounded">Low Impact</span>
                                <span class="inline-block bg-secondary/10 text-secondary dark:bg-secondary/20 dark:text-secondary-light text-xs px-2 py-1 rounded">Flexibility</span>
                            ...
                            <form action="start_session.php" method="POST">
                                <input type="hidden" name="session_type" value="Beginner Stretch">
                    ...
                    <!-- Exercise Session Card 2 -->
                    <div class="meditation-session bg-gray-50 dark:bg-gray-700 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300 transform hover:-translate-y-1 fade-in" data-duration="10" data-category="strength">
                        <div class="relative">
                            <img src="https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80" alt="Strength Training" class="w-full h-48 object-cover">
                            <div class="absolute top-4 right-4 bg-white dark:bg-gray-800 text-primary px-3 py-1 rounded-full text-sm font-medium">
                                10 min
                            </div>
                            <div class="absolute top-4 left-4 bg-primary/80 text-white px-3 py-1 rounded-full text-sm font-medium">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Body Weight Strength</h3>
                            <p class="text-gray-600 dark:text-gray-300 mb-4">
                                Build strength with this body weight routine designed to target major muscle groups without equipment.
                            </p>
                            <div class="mb-4 flex flex-wrap gap-2">
                                <span class="inline-block bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary-light text-xs px-2 py-1 rounded">Strength Building</span>
                                <span class="inline-block bg-secondary/10 text-secondary dark:bg-secondary/20 dark:text-secondary-light text-xs px-2 py-1 rounded">No Equipment</span>
                            ...
                            <form action="start_session.php" method="POST">
                                <input type="hidden" name="session_type" value="Body Weight Strength">
                    ...
                    <!-- Exercise Session Card 3 -->
                    <div class="meditation-session bg-gray-50 dark:bg-gray-700 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300 transform hover:-translate-y-1 fade-in" data-duration="20" data-category="cardio">
                        <div class="relative">
                            <img src="https://images.unsplash.com/photo-1434596922112-19c563067271?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80" alt="Cardio Workout" class="w-full h-48 object-cover">
                            <div class="absolute top-4 right-4 bg-white dark:bg-gray-800 text-primary px-3 py-1 rounded-full text-sm font-medium">
                                20 min
                            </div>
                            <div class="absolute top-4 left-4 bg-primary/80 text-white px-3 py-1 rounded-full text-sm font-medium">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">High Energy Cardio</h3>
                            <p class="text-gray-600 dark:text-gray-300 mb-4">
                                Boost your energy and burn calories with this high-intensity cardio routine that gets your heart pumping.
                            </p>
                            <div class="mb-4 flex flex-wrap gap-2">
                                <span class="inline-block bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary-light text-xs px-2 py-1 rounded">High Intensity</span>
                                <span class="inline-block bg-secondary/10 text-secondary dark:bg-secondary/20 dark:text-secondary-light text-xs px-2 py-1 rounded">Calorie Burning</span>
                            ...
                            <form action="start_session.php" method="POST">
                                <input type="hidden" name="session_type" value="High Energy Cardio">
                    ...
                    <!-- Exercise Session Card 4 -->
                    <div class="meditation-session bg-gray-50 dark:bg-gray-700 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300 transform hover:-translate-y-1 fade-in" data-duration="15" data-category="flexibility">
                        <div class="relative">
                            <img src="https://images.unsplash.com/photo-1588286840104-8957b019727f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80" alt="Flexibility Training" class="w-full h-48 object-cover">
                            <div class="absolute top-4 right-4 bg-white dark:bg-gray-800 text-primary px-3 py-1 rounded-full text-sm font-medium">
                                15 min
                            </div>
                            <div class="absolute top-4 left-4 bg-primary/80 text-white px-3 py-1 rounded-full text-sm font-medium">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Full Body Flexibility</h3>
                            <p class="text-gray-600 dark:text-gray-300 mb-4">
                                Improve your range of motion and prevent injuries with this complete flexibility routine for the entire body.
                            </p>
                            <div class="mb-4 flex flex-wrap gap-2">
                                <span class="inline-block bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary-light text-xs px-2 py-1 rounded">Deep Stretch</span>
                                <span class="inline-block bg-secondary/10 text-secondary dark:bg-secondary/20 dark:text-secondary-light text-xs px-2 py-1 rounded">Muscle Recovery</span>
                                <span class="inline-block bg-gray-100 dark:bg-gray-600 text-gray-700 dark:text-gray-300 text-xs px-2 py-1 rounded">All Levels</span>
                            </div>
                            <form action="start_session.php" method="POST">
                                <input type="hidden" name="session_type" value="Full Body Flexibility">
